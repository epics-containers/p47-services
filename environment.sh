...
# Reach the p47 gateways through the ssh tunnel that ./ca-forward.sh opens
# (localhost:9064 for CA, localhost:9075 for PVA). The tunnel works both on
# site and over the VPN.
#
# Clients in the controls dev network also find the IOCs directly, because
# AUTO_ADDR_LIST stays enabled.
